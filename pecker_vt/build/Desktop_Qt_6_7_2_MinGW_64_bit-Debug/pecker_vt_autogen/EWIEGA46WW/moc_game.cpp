...
Q_CONSTINIT const QMetaObject Game::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSGameENDCLASS_t,
        ...
        // method 'game_pause'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 's_update_central_vidget'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void Game::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->game_pause(); break;
        case 2: _t->s_update_central_vidget(); break;
        default: ;
        }
        ...
        {
            using _t = void (Game::*)();
            if (_t _q_method = &Game::game_start; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Game::*)();
            if (_t _q_method = &Game::game_pause; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Game::*)();
            if (_t _q_method = &Game::s_update_central_vidget; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 2
void Game::s_update_central_vidget()
{
